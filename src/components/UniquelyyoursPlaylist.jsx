...
export default function UniquelyyoursPlaylist() {
  ...
  const url =
    "https://api.spotify.com/v1/browse/categories/0JQ5DAqbMKFCbimwdOYlsl/playlists?limit=6&offset=0";
  ...
  return (
    <Container>
      <div className="container">
        <h2 className="top__mixes_title">Uniquely yours</h2>
